					...
					<div class="x_content">
						...
						<form class="form-horizontal form-label-left">
							<div class="profile_title">
								<h1 class="center-block">休日マスタ</h1>
							</div>
							<div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12">年度</label>
								<div class="col-md-1 col-sm-1 col-xs-12">
									<input type="text" class="form-control">
								</div>
								<div class="col-md-1 col-sm-1 col-xs-1">
									<button type="button" class="btn btn-default btn-sm"
										disabled="disabled">&nbsp;参照&nbsp;</button>
								</div>
							</div>
							<!-- table 시작 -->
							<div class="x_panel">
							...
							<!-- 테이블 끝 -->
							<div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12">日付</label>
								<div class="col-md-1 col-sm-1 col-xs-12">
									<input type="text" class="form-control">
								</div>
							</div>
						...
						<!-- 버튼 -->
						<div>
							<span class="col-md-1 col-sm-1 col-xs-1"> </span> <span
								class="col-md-1 col-sm-1 col-xs-1">
								<button type="button" class="btn btn-default btn-sm"
									disabled="disabled">&nbsp;コピー&nbsp;</button>
