...
//		SCUR_PAGE = sCur_Page;
//		
//		return "redirect: board/view_List";
////		return "board/view_List";
//	}
...
//			IDao dao = sqlSession.getMapper(IDao.class);
			boardDao.upNoDao();
//			boardDao.writeDao(contentBean.getUser(), contentBean.getTitle(), 
//					          contentBean.getDate());
	...
	public Map<String, Object> selectContent(@RequestBody ContentBean contentBean) 
		...
		try {
//			IDao dao = sqlSession.getMapper(IDao.class);
//			boardDao.hitDao(contentBean.getNo());
			map.put("mContent", boardDao.contentDao(contentBean.getNo()));
//			map.put("mContent", boardDao.contentDao(contentBean));
		}catch(Exception e) {
			e.printStackTrace();
			resultMsg = "e : " + e;	
			result = "fail";
...
//			map.put("mModify", boardDao.contentDao(contentBean));
		}catch(Exception e) {
			e.printStackTrace();
			resultMsg = "e : " + e;
			result = "fail";
