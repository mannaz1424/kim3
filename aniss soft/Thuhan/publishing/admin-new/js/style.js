$(function(){
    ...
    $('#btn_members_list').click(function(){
        $('#pop_members_list').fadeIn(300);
    })
    $('.btn_group_edit').click(function(){
        $('#pop_group_edit').fadeIn(300);
    })
    $('#btn_mailing_list').click(function(){
        $('#pop_mailing_list').fadeIn(300);
    })
    $('.btn_template_list').click(function(){
        $('#pop_template_list').fadeIn(300);
    })
